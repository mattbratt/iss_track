...
- Adds an "ISS Track" panel to the Home Assistant sidebar automatically, with no manual dashboard setup. *
...
All frontend assets (map images, fonts, satellite.js, astronomy.browser.js) are served directly from the integration, so nothing needs to be copied into `config/www/`.
